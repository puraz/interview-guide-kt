...
3.接口参数少时使用@RequestParam接收，多时定义一个实体，实体的名称要以Param结尾，使用@RequestBody接收；默认不使用@PathVariable，但为对齐 interview 与 knowledgebase/rag-chat 模块的原始RESTful路径，允许在这些模块中使用@PathVariable
