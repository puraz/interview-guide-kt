package com.example.framework.core.redis.aspect

import com.example.framework.core.redis.annotation.Limit
import com.example.framework.core.redis.enmus.LimitType
import com.example.framework.core.redis.exception.LimitException
import com.example.framework.core.redis.helper.RedisHelper
...
class LimitAspect(private val redisHelper: RedisHelper) {
    ...
    @Around("@annotation(com.example.framework.core.redis.annotation.Limit)")
